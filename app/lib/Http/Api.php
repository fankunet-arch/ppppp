...
final class Api
{
    ...
    private const MESSAGES = [
        ...
        'zero_allocation'        => '有一位客人既没分到金额也没分到份数，请先取消他再提交',
        ...
        // 破例放行、强制核销、撤销……凡是不可逆或减钱的动作都走这一条
        'reason_required'        => '这一步必须写明原因',
    ...
    private const MESSAGES_ES = [
        ...
        'zero_allocation'        => 'Un socio no tiene ni importe ni menús asignados; quítelo antes de enviar',
        ...
        'reason_required'        => 'Este paso requiere indicar el motivo por escrito',
