...
```bash
php tests/run.php                 # 887 项，不需要数据库
php tests/smoke.php --fresh       # 458 项，需要一个【专用空库】
php tests/e2e_pos.php             # 95 项，需要 POS 可达
php tests/http_sweep.php          # 64 项，对着跑起来的站点打全部接口
node tests/browser/*.mjs          # 524 项，真浏览器，仅开发机
```
